...
LINEAR_TOL = 0.005 # m 
LINEAR_MIN_SPEED = 0.03 # m/s
LINEAR_RAMP_TIME = 4.0 # s
LINEAR_RAMP_SPEED = 2.3 # m/s
LINEAR_GAIN = 4.0 # converts m to m/s
...
def solve_maze(m, x0, y0, dir, x1, y1):
    ...
    # TODO: writeme
    rospy.logerr('maze solving not implemented yet!')
    sys.exit(1)
...
class Controller:
    ...
    def control_callback(self, timer_event=None):
        ...
        if self.state == 'initializing':
            ...
            # TODO: write me!
            rospy.logerr('forward/backward not implemented yet!')
            rospy.signal_shutdown('fix me!')
